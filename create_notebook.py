"""
Script to generate the complete Colab notebook (.ipynb) for the gesture recognition pipeline.
Run this locally: python create_notebook.py
Then upload the generated .ipynb to Google Colab.
"""
import json
import os
...
# ============================================================
cells.append(make_md_cell(["## Step 0: Setup - Mount Drive & Install Dependencies"]))
...
# ============================================================
cells.append(make_md_cell(["## Step 0.1: Configuration"]))
cells.append(make_code_cell([
...
# ============================================================
cells.append(make_md_cell(["### Run Preprocessing"]))
cells.append(make_code_cell([
    "print('='*60)\n",
...
# ============================================================
# CELL 6: Run Augmentation
# ============================================================
cells.append(make_md_cell(["### Run Augmentation"]))
cells.append(make_code_cell([
    "print('='*60)\n",
...
# CELL 10: Plots
# ============================================================
cells.append(make_md_cell(["### Generate Evaluation Plots"]))
cells.append(make_code_cell([
    "# ---- Training Curves ----\n",
...
output_path = "Sign_Language_CNN_LSTM_NLP.ipynb"
...
print("\nNext: Upload this .ipynb to Google Colab!")
